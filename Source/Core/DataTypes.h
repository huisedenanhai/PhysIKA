...
template <>
inline const char* DataType1f::getName()
{
    return "DataType1f";
}
...
template <>
inline const char* DataType2f::getName()
{
    return "DataType2f";
}
...
template <>
inline const char* DataType3f::getName()
{
    return "DataType3f";
}
...
template <>
inline const char* DataType1d::getName()
{
    return "DataType1d";
}
...
template <>
inline const char* DataType2d::getName()
{
    return "DataType2d";
}
...
template <>
inline const char* DataType3d::getName()
{
    return "DataType3d";
}
