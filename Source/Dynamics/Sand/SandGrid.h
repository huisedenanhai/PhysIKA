...
public:
    ...
    DeviceArrayPitch2D4f& getSandGridData()
    {
        return m_sandGrid;
    }
    const DeviceArrayPitch2D4f& getSandGridData() const
    {
        return m_sandGrid;
    }
