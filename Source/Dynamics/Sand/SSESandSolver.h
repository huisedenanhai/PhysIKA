...
public:
    ...
    {
        m_sandData.setSandGridHeight(sandheight);
    }
    ...
    {
        m_sandData.getSandGridHeight(sandheight);
    }
    ...
    SandGrid& getSandGrid()
    {
        return m_sandData;
    }
    const SandGrid& getSandGrid() const
    {
        return m_sandData;
    }
